...
TrajOpt::TrajOpt(const TrajOptCfg& cfg) {
  // N_ = cfg.N;
  K_ = cfg.K;
  ...
  rhoT_ = cfg.rhoT;
  rhoP_ = cfg.rhoP;
  rhoTracking_ = cfg.rhoTracking;
  rhosVisibility_ = cfg.rhosVisibility;
  theta_clearance_ = cfg.theta_clearance;
  rhoV_ = cfg.rhoV;
  rhoA_ = cfg.rhoA;
  tracking_dur_ = cfg.tracking_dur;
  tracking_dist_ = cfg.tracking_dist;
  tracking_dt_ = cfg.tracking_dt;
  clearance_d_ = cfg.clearance_d;
  tolerance_d_ = cfg.tolerance_d;
}
